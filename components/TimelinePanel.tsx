    ...
    <div className="bg-gray-800 rounded-xl shadow-lg p-4 border border-gray-700 w-full flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-gray-700 p-2 rounded-lg">
        <div className="flex items-center gap-4">
            <button onClick={onPlayToggle} className="p-2 rounded-md bg-cyan-600 hover:bg-cyan-700 text-white transition-colors" aria-label={isPlaying ? "Tạm dừng" : "Phát"}>
                {isPlaying ? (
        ...
        <button 
          ...
          className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md transition-colors duration-200 disabled:opacity-50 disabled:cursor-wait"
        ...
        >
          ...
          {isExportingVideo ? 'Đang xuất...' : 'Xuất Video'}
        </button>
      </div>
